...
group_by(pulitzer, Newspaper) %>% summarise(gained.prizes.2004.2014 = Pulitzer.Prize.Winners.and.Finalists..2004.2014) %>% 
  arrange(-gained.prizes.2004.2014) 
...
filtered <- group_by(pulitzer, Newspaper) %>% filter(Pulitzer.Prize.Winners.and.Finalists..2004.2014 > 4) %>% 
